...
public class MdcAllFieldsTest {
	...
	private final void assertMdcFields(final String expectedJson,
		...
		MdcFields mdcFields = new MdcAllFields();
	...
	private interface MdcAssertorHelper {
		void test(JsonGenerator jsonGenerator, MdcFields mdcFields) throws JsonGenerationException,
				IOException;
	}
}
